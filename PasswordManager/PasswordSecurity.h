...
public:
	...
	vector<vector<vector<int>>> decrypt_password(string password);
	vector<int> decrypt_password_first_result(string password);
	vector<string> decrypt_string(string password, const string filename);
